...
export const routes: Routes = [
    ...
    { path: 'profile', loadComponent: () => import('./components/auth/profile/profile').then(m => m.Profile) },
    { path: 'paramettre', loadComponent: () => import('./components/auth/paramettre/paramettre').then(m => m.Paramettre) },
    { path: 'notifications', loadComponent: () => import('./layout/notifications/notifications').then(m => m.Notificationss) },
